      ...
      <Row>
        <Col md={8} lg={9}>
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            ...
            <Row className="mb-5">
              <Col>
                <Form.Label className="fw-bold">Billing to:</Form.Label>
                <Form.Control placeholder={"Customer Name"} rows={3} value={this.state.billTo} type="text" name="billTo" className="my-2" onChange={(event) => this.editField(event)} autoComplete="name" required="required" />
                <Form.Control placeholder={"Mobile number"} value={this.state.billToMobile} type="tel" name="billToMobile" className="my-2" onChange={(event) => this.editField(event)} autoComplete="tel" required="required" />
                <Form.Control as="select" value={this.state.paymentMethod} onChange={(event) => this.editField(event)} name="paymentMethod" className="my-2" required="required">
              ...
              <Col className='adr'>
                <Form.Label className="fw-bold">Billing from:</Form.Label>
                <div className="my-2">
                  <strong style={{fontFamily: 'Akshar', fontSize: '1.5rem' }}> वानखेडे कृषी-सेवा केंद्र </strong>
                </div>
                <div className="my-2">
                  <strong>Mobile number : <span style={{ fontFamily: 'Arial, sans-serif', fontWeight: 'bold', fontSize: '1.1rem', color: '#333' }}>+91 9823332198</span></strong>
                </div>
                <div className="my-2" style={{ fontFamily: 'Arial, sans-serif', fontSize: '1rem', lineHeight: '1.6' }}>
                  <strong>Billing address:</strong>
                  <br />
                  <span>
                    At.Penur Post.Kawalgaon<br />
                    Tq.Purna Dist.Parbhani<br />
                    431511.
                  </span>
                </div>
            ...
            <hr className="my-4" />
            <Form.Label className="fw-bold">Greetings : </Form.Label>
            <strong style={{ fontSize: '1.2rem ' }}> Thank You For Visiting Wankhede Krushi-Seva Kendra </strong>
        ...
        <Col md={4} lg={3}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            ...
            <Form.Group className="my-3">
              <Form.Label className="fw-bold">GST Tax:</Form.Label>
              <InputGroup className="my-1 flex-nowrap">
                <Form.Control name="taxRate" type="number" value={this.state.taxRate} onChange={(event) => this.editField(event)} className="bg-white border" placeholder="0.0" min="0.00"  max="100.00" />
            ...
            <Form.Group className="my-3">
              ...
              <InputGroup className="my-1 flex-nowrap">
                <Form.Control name="discountRate" type="number" value={this.state.discountRate} onChange={(event) => this.editField(event)} className="bg-white border" placeholder="0.0" min="0.00"  max="100.00" />
                <InputGroup.Text className="bg-light fw-bold text-secondary small">
                  %
                </InputGroup.Text>
              </InputGroup>
